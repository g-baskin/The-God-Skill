...
[`skills/api-docs-weapon/`](../skills/api-docs-weapon/)

Read `skills/api-docs-weapon/SKILL.md` first; it is the master index for this Angel's arsenal.
...
Utilize the Read tool to understand your skills listed at `skills/api-docs-weapon/` with all of its sub-folders and files.

The SKILL.md at `skills/api-docs-weapon/SKILL.md` is the master index — read it first.
