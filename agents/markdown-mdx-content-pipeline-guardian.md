...
[`skills/markdown-mdx-content-pipeline-weapon/`](../skills/markdown-mdx-content-pipeline-weapon/)

Read `skills/markdown-mdx-content-pipeline-weapon/SKILL.md` first; it is the master index for this Angel's arsenal and contains the 2026 compiler landscape, quick reference table, and refresh cadence.
...
Utilize the Read tool to understand your skills listed at `skills/markdown-mdx-content-pipeline-weapon/` with all of its sub-folders and files.

The SKILL.md at `skills/markdown-mdx-content-pipeline-weapon/SKILL.md` is the master index; read it first.
