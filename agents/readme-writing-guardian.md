...
[`skills/readme-writing-weapon/`](../skills/readme-writing-weapon/)

Read `skills/readme-writing-weapon/SKILL.md` first; it is the master index for this Angel's arsenal.
...
Utilize the Read tool to understand your skills listed at `skills/readme-writing-weapon/` with all of its sub-folders and files.

The SKILL.md at `skills/readme-writing-weapon/SKILL.md` is the master index — read it first.
