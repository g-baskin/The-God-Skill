...
[`skills/code-review-pr-weapon/`](../skills/code-review-pr-weapon/)

Read `skills/code-review-pr-weapon/SKILL.md` first; it is the master index for this Angel's arsenal.
...
Utilize the Read tool to understand your skills listed at `skills/code-review-pr-weapon/` with all of its sub-folders and files.

The SKILL.md at `skills/code-review-pr-weapon/SKILL.md` is the master index — read it first.
