...
[`skills/lighthouse-pagespeed-weapon/`](../skills/lighthouse-pagespeed-weapon/)

Read `skills/lighthouse-pagespeed-weapon/SKILL.md` first; it is the master index for this Angel's arsenal.
...
Utilize the Read tool to understand your skills listed at `skills/lighthouse-pagespeed-weapon/` with all of its sub-folders and files.

The SKILL.md at `skills/lighthouse-pagespeed-weapon/SKILL.md` is the master index — read it first.
